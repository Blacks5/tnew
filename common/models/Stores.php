 ...
 */
class Stores extends \app\core\base\BaseActiveRecord
{
    // 10正常  1审核拒绝 2关闭
    ...
    {
        return [
            [['s_name', 's_owner_email', 's_owner_phone', 's_owner_name', 's_remark', 's_county', 's_bank_people_name', 's_bank_num', 's_bank_sub', 's_bank_addr',
