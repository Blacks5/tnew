 ...
 */
class Product extends \app\core\base\BaseActiveRecord
{
    const STATUS_OK = 10;
    const STATUS_STOP = 1;
    const STATUS_DEL = 0;
    ...
    {
        return [
            [['p_name', 'p_period', 'p_month_rate', 'p_add_service_fee', 'p_free_pack_fee', 'p_finance_mangemant_fee', 'p_customer_management'], 'required', 'except' => 'search'],
