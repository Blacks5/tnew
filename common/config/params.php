...
//        ['kinship_id'=>7, 'kinship_str'=>'表姐妹'],
    ...
    'company_kind'=>[
        ...
        ['company_kind_id'=>6, 'company_kind_name'=>'教育'],
        ['company_kind_id'=>7, 'company_kind_name'=>'金融机构、专业性事务机构'],
        ['company_kind_id'=>8, 'company_kind_name'=>'政府机构、社会团队'],
        ['company_kind_id'=>9, 'company_kind_name'=>'计算机、通信、通讯'],
        ['company_kind_id'=>10, 'company_kind_name'=>'制造、快速消费品、耐用消费品'],
        ['company_kind_id'=>11, 'company_kind_name'=>'能源、化工、矿产'],
        ['company_kind_id'=>12, 'company_kind_name'=>'军队'],
        ['company_kind_id'=>13, 'company_kind_name'=>'电力、煤气、水的生成和供应'],
        ['company_kind_id'=>14, 'company_kind_name'=>'房地产'],
        ['company_kind_id'=>15, 'company_kind_name'=>'个体、自营、退休、居住、家政和其他服务'],
        ['company_kind_id'=>16, 'company_kind_name'=>'科研、地质勘探和技术服务'],
        ['company_kind_id'=>17, 'company_kind_name'=>'事业单位、公共设施、医疗卫生、社会保障'],
        ['company_kind_id'=>18, 'company_kind_name'=>'租赁和商业服务'],
        ['company_kind_id'=>19, 'company_kind_name'=>'批发和零售贸易'],
        ['company_kind_id'=>20, 'company_kind_name'=>'其他'],
    ]
];
