                ...
                $.post(_this.url , request , function(res){
                    if(res.status){
                        ...
                        for(var i in res.data.data){
                            ...
                            html += '<div class="weui-form-preview" data-o-id="' + item.orderID +'" data-o-status="' +item.orderStatus+ '" data-o-operateable="'+item.canVisitor+'"><div class="weui-form-preview__hd"><label class="weui-form-preview__label">' + item.customerName + '</label><em class="weui-form-preview__value">　</em></div><div class="weui-form-preview__bd"><div class="weui-form-preview__item"><label class="weui-form-preview__label">订单编号</label><span class="weui-form-preview__value">' + item.orderNumber + '</span></div><div class="weui-form-preview__item"><label class="weui-form-preview__label">申请金额</label><span class="weui-form-preview__value">' + parseFloat(item.applyAmount).toFixed(2) + '元</span></div><div class="weui-form-preview__item"><label class="weui-form-preview__label">放款金额</label><span class="weui-form-preview__value">' + (item.acceptAmount ? parseFloat(item.acceptAmount).toFixed(2) + '元' : '-') + '</span></div><div class="weui-form-preview__item"><label class="weui-form-preview__label">借款用途</label><span class="weui-form-preview__value">' + (item.purpose ? item.purpose : '-') + '</span></div><div class="weui-form-preview__item"><label class="weui-form-preview__label">客户电话</label><span class="weui-form-preview__value">' + item.orderPhone + '</span></div><div class="weui-form-preview__item"><label class="weui-form-preview__label">客户地址</label><span class="weui-form-preview__value">' + item.orderAddress + '</span></div><div class="weui-form-preview__item"><label class="weui-form-preview__label">销售姓名</label><span class="weui-form-preview__value">' + (item.saleName ? item.saleName : '-') + '</span></div><div class="weui-form-preview__item"><label class="weui-form-preview__label">邀请人姓名</label><span class="weui-form-preview__value">' + (item.inviteName ? item.inviteName : '-') + '</span></div><div class="weui-form-preview__item"><label class="weui-form-preview__label">申请时间</label><span class="weui-form-preview__value">' + (item.applyTime.date).split('.')[0] + '</span></div><div class="weui-form-preview__item"><label class="weui-form-preview__label">备注</label><span class="weui-form-preview__value">' + (item.remark ? item.remark : '-') + '</span></div>';
