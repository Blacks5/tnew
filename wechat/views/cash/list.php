                ...
                $.post(_this.url , request , function(res){
                    if(res.status){
                        ...
                        for(var i in res.data.data){
                            ...
                            html += '<div class="weui-form-preview" data-o-id="' + item.orderID +'" data-o-status="' +item.orderStatus+ '"><div class="weui-form-preview__hd"><label class="weui-form-preview__label">' + item.customerName + '</label><em class="weui-form-preview__value">　</em></div><div class="weui-form-preview__bd"><div class="weui-form-preview__item"><label class="weui-form-preview__label">订单编号</label><span class="weui-form-preview__value">' + item.orderNumber + '</span></div><div class="weui-form-preview__item"><label class="weui-form-preview__label">申请金额</label><span class="weui-form-preview__value">' + item.applyAmount + '元</span></div><div class="weui-form-preview__item"><label class="weui-form-preview__label">客户电话</label><span class="weui-form-preview__value">' + item.orderPhone + '</span></div><div class="weui-form-preview__item"><label class="weui-form-preview__label">客户地址</label><span class="weui-form-preview__value">' + item.orderAddress + '</span></div><div class="weui-form-preview__item"><label class="weui-form-preview__label">申请时间</label><span class="weui-form-preview__value">' + (item.applyTime.date).split('.')[0] + '</span></div>';
