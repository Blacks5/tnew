            ...
            <ul class="nav" id="side-menu">
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a class="J_menuItem" href="<?= Url::toRoute(['test']); ?>" data-index="0">test</a>
                        </li>
                        <li>
        ...
        <div class="row content-tabs">
            ...
            <nav class="page-tabs J_menuTabs">
                <div class="page-tabs-content">
                    <a href="javascript:;" class="active J_menuTab" data-id="<?= Url::toRoute(['test']); ?>">首页</a>
                </div>
            </nav>
...
<?= Html::jsFile('@web/static/js/plugins/metisMenu/jquery.metisMenu.js') ?>
<?= Html::jsFile('@web/static/js/plugins/slimscroll/jquery.slimscroll.min.js') ?>
<?= Html::jsFile('@web/static/js/plugins/layer/layer.min.js') ?>

<!-- 自定义js -->
<?= Html::jsFile('@web/static/js/hplus.js?v=4.1.0') ?>
<?= Html::jsFile('@web/static/js/contabs.js', ['type' => 'text/javascript']) ?>

<!-- 第三方插件 -->
<?= Html::jsFile('@web/static/js/plugins/pace/pace.min.js') ?>
