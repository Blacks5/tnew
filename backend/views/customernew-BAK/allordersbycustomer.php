        ...
        <div class="col-sm-12">
            <div class="ibox">
                <div class="ibox-content">
                    ...
                    <?php if($customer){ ?>
                        <h1>【<?=$customer['c_customer_name']. '】的订单'?></h1>
                    <?php } ?>

                    <form class="row" method="get" action="">
                        <?php if($customer){ ?>
                            <input type="hidden" name="OrdersSearch[customer_id]" placeholder="customer_id"
                                   value="<?=$sear['customer_id']; ?>" class="input form-control">
                        <?php } ?>
