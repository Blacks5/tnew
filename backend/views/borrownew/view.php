                        ...
                        <div class="col-sm-12">
                            <?php if($model['o_status'] == 10 && $isRepayment==0){ ?>
                                    ...
                                    <div class="input-group">
                                        <select class="col-md-8 form-control" id="period_num">
                                            <?php for($i = 0;$i < $repayCount;$i++) { ?>
                                                <option value="<?php echo $i+1; ?>"><?= $isOverdue < $i + 1 ? '': '<逾期>' ?>还<?php echo $i+1; ?>期</option>
                                            <?php } ?>
                                        </select>
                                ...
                                <div class="com-md-8">
                                    ...
                                    <?php }?>
                                    <?php if($model['o_is_add_service_fee'] == 1 && $reCount == 1){ ?>
                                        <button class="btn btn-danger" id="cancel_personal_protection">取消个人保障计划</button>
                                    <?php }?>
                                    <?php if($model['o_is_free_pack_fee'] == 1 && $reCount == 1){ ?>
