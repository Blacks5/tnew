                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-striped table-hover">
                                                ...
                                                <tr>
                                                    ...
                                                    <th><a data-toggle="tab" href="#contact-3" class="client-link">部门名</a></th>
                                                    <th>操作</th>
                                                </tr>
                                                </thead>
                                                <tbody>
                                                ...
                                                foreach ($model as $_k=>$_v){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a data-toggle="tab" href="#contact-3" class="client-link"><?= $_v['j_name']?></a></td>
                                                        <td>
                                                            <a class="button" href="<?= Yii::$app->getUrlManager()->createUrl(['department/update-job','d_id'=>$_v['j_id']]); ?>">编辑</a>
                                                            <a class="button" href="javascript:del('<?= $_v['j_name']?>', <?= $_v['j_id']?>)">删除</a>
                                                        </td>
                                                    </tr>
                                                <?php }?>
                                                <script>
